...
./build/examples/filter/convert_filter_data.bin $DATA/3picAllTrain.txt $EXAMPLE/filter_train_leveldb 15352
./build/examples/filter/convert_filter_data.bin $DATA/3picAllTest.txt $EXAMPLE/filter_test_leveldb 15352
